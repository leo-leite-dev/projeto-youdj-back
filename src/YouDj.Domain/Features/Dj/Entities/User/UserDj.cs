...
namespace YouDj.Domain.Features.Dj.Entities.User;

public sealed class UserDj : EntityBase
{
    ...
    public static UserDj Create(Email email, Username Username, string rawPassword,
        DateOfBirth birthDate, Func<string, string> hash)
    {
        ...
        UserDj.SetPassword(rawPassword, hash);
        return UserDj;
    }
